package com.example.potik.mvvmpattern.manager;
...
public class ApiManager {
    ...
    public void getPost(final String postId, final GetPostCallback callback) {
        new Thread() {
            ...
            public void run() {
                ...
                // Return results in UI Thread
                new Handler(Looper.getMainLooper()).post(() -> callback.onResponse(createDummyPost(Integer.parseInt(postId))));
            }
        }.start();
    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                new Handler(Looper.getMainLooper()).post(() -> {
                    new Post(String.valueOf(22), "New Post " + 22, 22 + " " + "some Description", "https://lh3.googleusercontent.com/2e9FAnwgd9P0BvMr-lIFyJcwPA8jm3WiX_sP44pTx17wdwzN4jc3BmQW72bl-BPkM--4=w300-rw");
                    callback.onResponse();
                });
            }
        }.start();
    ...
    private Post createDummyPost(int position) {
